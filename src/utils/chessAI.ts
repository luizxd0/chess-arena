...
export const botsList: Bot[] = [
  ...
  },
  {
    ...
    rating: 700,
    tier: 'Beginner',
    personality: 'A solid beginner player who loves to play fast and try out creative knight jumps.',
    blunderRate: 0.30,
    depth: 2,
  ...
  },
  {
    ...
    rating: 1200,
    tier: 'Intermediate',
    personality: 'Infamous for bringing his Queen out on move 2. If you survive his early queen attacks, you will win.',
    blunderRate: 0.18,
    depth: 2,
  ...
  },
  {
    ...
    rating: 2300,
    tier: 'Advanced',
    personality: 'Plays at lightning speed. Constantly evaluates positions out loud, repeating "Let\'s keep moving, take take take, check, and we win."',
    blunderRate: 0.01,
    depth: 4,
