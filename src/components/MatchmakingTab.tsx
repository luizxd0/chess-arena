    ...
    <div className="w-full h-full flex flex-col min-h-0">
      ...
      {game && matchedOpponent && (
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-stretch flex-1 min-h-0 overflow-x-hidden overflow-y-auto pb-1 md:pb-2">
          ...
          <div className="flex-1 w-full max-w-[min(100vw-24px,100dvh-200px)] md:max-w-[min(100vw-360px,100dvh-320px)] lg:max-w-[min(100vw-400px,100dvh-320px)] mx-auto flex flex-col items-center justify-center min-h-0 shrink-0">
